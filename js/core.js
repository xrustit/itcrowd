...
// Создаем собственный сселектор, работающий с RegExp
...
$( "select[name='unit_id']" ).change(function() {
	switch ($(this).val()) {
        ...
        case '1':
				//alert($("#err").val());
        		//alert($(this).val());
				//$('#subj').val($('#subj').val() + '<span class="dogov"></span>');
		if ($("#edit_adr:findContent(ПК)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
			} 
		else if ($("#edit_adr:findContent(ПК-ВЫЕЗД)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
		}
		else if ($("#edit_adr:findContent(пусто)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
		};            
        break;
        case '5':
    if ($("#edit_adr:findContent(САЙТ)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
		} 
    else if ($("#edit_adr:findContent(ХОСТ)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
	}
    else if ($("#edit_adr:findContent(пусто)").length) { 
    ...
    if ($("#edit_adr:findContent(ПК)").length) {
    ...
    else if ($("#edit_adr:findContent(ПК-САЙТ)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');	
		}
    else if ($("#edit_adr:findContent(ПК-ХОСТ)").length) {
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
		}
    else if ($("#edit_adr:findContent(САЙТ)").length) {
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
		}	
    else if ($("#edit_adr:findContent(ХОСТ)").length) {
		...
		break;
        case '10':
    if ($("#edit_adr:contains(пусто)").length) { 
			$( ".dogovor" ).css( "background-color", "#9a2a26" );
			$("#err").val('1');
	};  		
		break;
        ...
        case '9':		
		//alert($(this).val());
            $( ".dogovor" ).css( "background-color", "transparent" );
			//$("#err").val('0');
        break;
        default:
        break;
   ...
   //$('#content tr td:contains("Выезд")').css('background-color', 'rgba(255, 0, 0, 0.5)');

   //$('tr td:contains("Выезд")').css('background-color', 'rgba(201, 237, 253, 0.9)');
...
var urlsrc = MyHOSTNAME+"/inc/json.php?fio"; 
    $("#fio").autocomplete({ 
        maxShowItems: 5,
        minLength: 2,
        source: urlsrc
...
/* function(request, response) {
        var results = $.ui.autocomplete.filter(urlsrc, request.term);        
...
makemytime(true);
                    ...
                    $('#for_fio').addClass('has-success');
                        ...
                        success: function(html) {
                            ...
                            $('#new_tel2').editable({inputclass: 'input-sm',emptytext: 'пусто'});
                            $('#new_tel3').editable({inputclass: 'input-sm',emptytext: 'пусто'});
                            $('#new_adr').editable({inputclass: 'input-sm',emptytext: 'пусто'});
                            $('#new_mail').editable({inputclass: 'input-sm', emptytext: 'пусто'});
                            $('#new_mail2').editable({inputclass: 'input-sm', emptytext: 'пусто'});
                            $('#new_mail3').editable({inputclass: 'input-sm', emptytext: 'пусто'});
                            $('#new_cod').editable({inputclass: 'input-sm', emptytext: 'пусто'});
                            $('#new_site').editable({inputclass: 'input-sm', emptytext: 'пусто'});
                            $('#new_region').editable({inputclass: 'input-sm',emptytext: 'пусто',mode: 'popup',showbuttons: false});							
                            makemytime(true);
                        }
                    });
...
/*Проверка заполненности поля msg*/
...
/////<!---->
    ...
    $('body').on('click', 'button#save_edit_ticket', function(event) {
		...
		var pr;	
		var today = new Date(); //тек. дата	
                var pr0 = p.slice(-1);			
		//var pr0 = p.replace(/[^\d]+/, '$1');	//убриаем знак
		var fdate = new Date(td.replace(/(\d+)-(\d+)-(\d+)/, '$2/$3/$1'));	//преобразовываем дату с поля в нужный формат

			if (fdate > today) { //если указанная дата больше текущей
				pr = "-" + pr0;
				//alert( 'на будущее '+fdate+' > '+today );
			} 
			//else if (fdate = today){
			//	pr=1;
			//} 
...
//alert(pr);
         ...
         $.ajax({
                ...
                data: "mode=save_edit_ticket"+
                    ...
                    "&prio="+encodeURIComponent(pr)+
                    "&tdate="+encodeURIComponent(td)+
			...
			//alert(pr);
                ...
                $.ajax({
                    ...
                    data: "mode=add_ticket"+
                        ...
                        "&tel2="+encodeURIComponent($("#new_tel2").text())+
                        "&tel3="+encodeURIComponent($("#new_tel3").text())+						
                        "&login="+encodeURIComponent($("#new_login").text())+
                        "&pod="+encodeURIComponent($("#new_unit").text())+
						"&region="+encodeURIComponent($("#new_region").text())+	
                        "&adr="+encodeURIComponent($("#new_adr").text())+
                        "&tel="+encodeURIComponent($("#new_tel").text())+
                        "&tel2="+encodeURIComponent($("#new_tel2").text())+
                        "&tel3="+encodeURIComponent($("#new_tel3").text())+							
                        "&mail="+encodeURIComponent($("#new_mail").text())+
                        "&mail2="+encodeURIComponent($("#new_mail2").text())+
                        "&mail3="+encodeURIComponent($("#new_mail3").text())+
                        "&cod="+encodeURIComponent($("#new_cod").text())+
                        "&msite="+encodeURIComponent($("#new_site").text())+						
                        ...
                        "&prio="+encodeURIComponent(pr)+
						"&err="+encodeURIComponent($("#err").val())+
						"&tdate="+encodeURIComponent(td)+						
...
pr = fdate > today ? '-1' : $("#prio").val();
                ...
                $.ajax({
                    ...
                    data: "mode=add_ticket"+
                        ...
                        "&tel2="+encodeURIComponent($("#edit_tel2").text())+
                        "&tel3="+encodeURIComponent($("#edit_tel3").text())+						
                        "&login="+encodeURIComponent($("#edit_login").text())+
                        "&pod="+encodeURIComponent($("#edit_unit").text())+
						"&region="+encodeURIComponent($("#edit_region").text())+						
                        "&adr="+encodeURIComponent($("#edit_adr").text())+
                        "&tel="+encodeURIComponent($("#edit_tel").text())+
                        "&tel2="+encodeURIComponent($("#edit_tel2").text())+
                        "&tel3="+encodeURIComponent($("#edit_tel3").text())+						
                        "&mail="+encodeURIComponent($("#edit_mail").text())+
                        "&mail2="+encodeURIComponent($("#edit_mail2").text())+
                        "&mail3="+encodeURIComponent($("#edit_mail3").text())+
                        "&cod="+encodeURIComponent($("#edit_cod").text())+
                        "&site="+encodeURIComponent($("#edit_site").text())+						
