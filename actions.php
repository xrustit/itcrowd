                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table  ">
                                ...
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_region');?>:</small></td>
                                    <td><small><a href="#" id="new_region" data-type="select" data-source="<?=$CONF['hostname'];?>/inc/json.php?region" data-pk="1" data-title="<?=lang('NEW_to_region');?>"></a></small></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_tel2');?>:</small></td>
                                    <td><small><a href="#" id="new_tel2" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_tel3');?>:</small></td>
                                    <td><small><a href="#" id="new_tel3" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_mail2');?>:</small></td>
                                    <td><small><a href="#" id="new_mail2" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_mail3');?>:</small></td>
                                    <td><small><a href="#" id="new_mail3" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_cod');?>:</small></td>
                                    <td><small><a href="#" id="new_cod" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_site');?>:</small></td>
                                    <td><small><a href="#" id="new_site" data-type="text" data-pk="1" data-title="Enter username"></a></small></td>
                                </tr>								
                                </tbody>
                            </table>
...
//запросы для поиска заявок 

            if ($priv_val == 0) {

                $stmt = $dbConnection->prepare('SELECT 
							id, user_init_id, user_to_id, date_create, subj, msg, client_id, unit_id, status, hash_name, is_read, lock_by, ok_by, prio, last_update, err
							from tickets
...
//вывод таблицы заявок /list



                <div class="table-responsive">
                <table id="myTable" class="table table-bordered table-hover tablesorter " style=" font-size: 15px; ">
                <thead>
                <tr>
...
////////////////////////////Показывает приоритет//////////////////////////////////////////////////////////////
                ...
                //if ($row['prio'] == "3") {$prio= "<span class=\"label label-warning\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".lang('t_list_a_p_high')."\"><i class=\"fa fa-minus-circle\"></i></span>"; }
...
////////////////////////////Показывает err//////////////////////////////////////////////////////////////
			...
			//like_match($row['id'], 'ПК%',$row['client_adr'])
        
				
				$unit=$row['unit_id'];
				//$un	= like_match($row['id'], 'ПК%',$row['client_adr']);
				//echo $un;
				
	//if ($unit == '0') {
				
				//if (like_match($row['id'], 'ПК%',$row['client_adr'])) {$err="errclass"};
				//echo like_match($row['id'], 'ПК%',$row['client_adr']);
	//} else if ($unit == '1') {
				//if (like_match('%uc%','Lucy')) {$err="errclass"};
	//} else if ($unit == '5') {
 
 // }		
		//if (like_match('ПК%',$row['client_adr']))

		//	{
		//	echo '<script type="text/javascript">alert("Data has been submitted to ' . $row['id'] . '");</script>';
			/*	switch($unit) {
					
		case '0': $err="errclass";break;
		case '1': $err="errclass";break;
		case '5': $err="errclass";break;
		case '6': $err="errclass";break;
		case '7': $err="errclass";break;
		case '10': $err="errclass";break;
			default: $err="errclass";
			}
			*/	
		//}		
              
                if ($row['err'] == "1") {$err="errclass"; }
                if ($row['unit_id'] == "7") {$outc="outclass"; }
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
switch($sort_type) {
	...
	default: 		unset($_SESSION['hd.rustem_sort_out']);
        ...
        if ($mode == "last_news") {
            ...
            if (isset($_POST['v'])) { $c=$_POST['v']; $start=($_POST['v']+10);}
...
foreach ($ee as $key=>$value) { $vv[":val_" . $key]=$value;}
	...
	or user_init_id=:uid2) and last_update > :lu');
        ...
        if ($mode == "find_worker") {
            ...
            $stmt = $dbConnection->prepare('SELECT id,fio,tel,tel2,tel3,unit_desc,adr,tel_ext,email,email2,email3,cod,site,login,region,posada FROM clients where fio like :fio');
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table  ">
                                ...
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_tel2');?>:</small></td>
                                    <td><small><?php echo $tel_user2." ".$tel_ext; ?></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_tel3');?>:</small></td>
                                    <td><small><?php echo $tel_user3." ".$tel_ext; ?></small></td>
                                </tr>								
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_room');?>:</small></td>
                                ...
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_mail2');?>:</small></td>
                                    <td><small><?=$mail2?></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_mail3');?>:</small></td>
                                    <td><small><?=$mail3?></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_cod');?>:</small></td>
                                    <td><small><?=$cod?></small></td>
                                </tr>
                                <tr>
                                    <td style=" width: 30px; "><small><?=lang('WORKER_site');?>:</small></td>
 ...
 <?php if ($tt <> 0) { ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" id="form_approve">
                                ...
                                <div class="form-group">
                                    <label for="region" class="col-sm-2 control-label"><small><?=lang('WORKER_region');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="region" class="form-control input-sm" id="region" placeholder="<?=lang('WORKER_region');?>" value="<?=$region;?>">
                                    </div>
                                </div>								
                                <div class="form-group">
        ...
        if ($mode == "aprove_yes") {
            ...
            $stmt = $dbConnection->prepare('SELECT id,fio,tel,tel2,tel3,unit_desc,adr,email,email2,email3,cod,site, login, posada,client_id FROM approved_info where id=:id');
            $stmt->execute(array(':id' => $id));
            $fio = $stmt->fetch(PDO::FETCH_ASSOC);
            ...
            $stmt = $dbConnection->prepare('update clients set fio=:qfio, tel=:tel, tel2=:tel2, tel3=:tel3, login=:qlogin, unit_desc=:qpod,
						adr=:adr, email=:email, email2=:email2, email3=:email3, cod=:cod, site=:site, posada=:posada where id=:cid');
            $stmt->execute(array(':qfio' => $qfio, ':tel' => $tel, ':tel2' => $tel2, ':tel3' => $tel3, ':qlogin' => $qlogin,':qpod' => $qpod,':adr' => $adr,':email' => $email, ':email2' => $email2, ':email3' => $email3, ':cod' => $cod, ':site' => $site, ':posada' => $posada, ':cid' => $cid));
...
$cl="";
        ...
        if ($mode == "send_zapit_add") {
			...
			(fio, tel, tel2, tel3, login, unit_desc, adr, email, email2, email3, cod, site, region, posada)
			VALUES (:pib, :tel, :tel2, :tel3, :login, :pid, :adr, :mail, :mail2, :mail3, :cod, :site, :region, :posada)');
            $stmt->execute(array(':pib' => $pib,':tel' => $tel,':tel2' => $tel2,':tel3' => $tel3,':login' => $login,':pid' => $pid,':adr' => $adr,':mail' => $mail,':mail2' => $mail2,':mail3' => $mail3,':cod' => $cod, ':site' => $site, ':region' => $region,':posada' => $posada));
...
(client_id, fio, tel, tel2, tel3, login, unit_desc, adr, email, email2, email3, cod, site, posada, user_from, date_app)
VALUES (:id, :pib, :tel, :tel2, :tel3, :login, :pid, :adr, :mail, :mail2, :mail3, :cod, :site, :region, :posada, :uf, now())');
...
$stmt = $dbConnection->prepare('SELECT id, subj, msg, prio, tdate FROM tickets where hash_name=:hn');
...
if ($tdate != $fio['tdate']) {
	            $stmt = $dbConnection->prepare('update tickets set tdate=:v, last_edit=now(), last_update=now() where hash_name=:pk');
            $stmt->execute(array(':v'=>$tdate, ':pk'=>$t_hash));
            ...
            $stmt = $dbConnection->prepare('INSERT INTO ticket_log (msg, date_op, init_user_id, ticket_id)
values (:edit_tdate, now(), :unow, :pk)');
            $stmt->execute(array(':edit_tdate'=>'edit_tdate', ':pk'=>$pk,':unow'=>$unow));
}
...
$mail->Password   = $CONF_MAIL['password'];   
  ...
  echo $e->getMessage(); //Boring error messages from anything else!
        ...
        if ($mode == "add_ticket") {
			...
			$tdate=(!empty($_POST['tdate']))? $_POST['tdate'] : date("Y-m-d H:i:s"); 
			...
			*/
			...
			$client_tel2=strip_tags(xss_clean(($_POST['tel2'])));
			$client_tel3=strip_tags(xss_clean(($_POST['tel3'])));
            ...
            $client_mail2=strip_tags(xss_clean(($_POST['mail2'])));
            $client_mail3=strip_tags(xss_clean(($_POST['mail3'])));			
            $client_posada=strip_tags(xss_clean(($_POST['posada'])));
			
	        $client_cod=strip_tags(xss_clean(($_POST['cod'])));
            $client_site=strip_tags(xss_clean(($_POST['site'])));
			$client_region=strip_tags(xss_clean(($_POST['region'])));			

            $client_id_param=($_POST['client_id_param']);

            if ($client_fio == "пусто") {$client_fio="";}
            if ($client_tel == "пусто") {$client_tel="";}
			if ($client_tel2 == "пусто") {$client_tel2="";}
			if ($client_tel3 == "пусто") {$client_tel3="";}
            ...
            if ($client_mail2 == "пусто") {$client_mail2="";}
            if ($client_mail3 == "пусто") {$client_mail3="";}			
            if ($client_posada == "пусто") {$client_posada="";}
            if ($client_cod == "пусто") {$client_cod="";}			
            if ($client_site == "пусто") {$client_site="";}	
            if ($client_region == "пусто") {$client_region="";}				
/*
...
*/
            ...
            if ($type == "add") {
                ...
                $stmt = $dbConnection->prepare('insert into clients 
			 (id, fio, tel, tel2, tel3 login, unit_desc, adr, email, email2, email3, cod, site, region, posada) VALUES 		
			 (:max_id, :client_fio, :client_tel, :client_tel2, :client_tel3, :client_login, :unit_desc, :client_adr, :client_mail, :client_mail2, :client_mail3, :client_cod, :client_site, :client_region, :client_posada)');
                ...
                $stmt = $dbConnection->prepare('INSERT INTO tickets
								(id, user_init_id,user_to_id,date_create,subj,msg, client_id, unit_id, status, hash_name, prio, last_update, err, tdate) VALUES (:max_id_res_ticket, :user_init_id, :user_to_id, now(),:subj, :msg,:max_id,:unit_id, :status, :hashname, :prio, now(), :err, :tdate)');
                $stmt->execute(array(':max_id_res_ticket'=>$max_id_res_ticket,':user_init_id'=>$user_init_id,':user_to_id'=>$user_to_id,':subj'=>$subj,':msg'=>$msg,':max_id'=>$max_id,':unit_id'=>$unit_id,':status'=>$status,':hashname'=>$hashname,':prio'=>$prio, ':err'=>$err, ':tdate'=>$tdate));
...
if ($CONF_MAIL['active'] == "true") {
            ...
            if ($type == "edit") {
                ...
                $stmt = $dbConnection->prepare('update clients set tel=:client_tel, tel2=:client_tel2, tel3=:client_tel3, login=:client_login, unit_desc=:unit_desc, adr=:client_adr, email=:client_mail, email2=:client_mail2, email3=:client_mail3, cod=:client_cod, site=:client_site, region=:client_region, posada=:client_posada where id=:client_id_param');

                $stmt->execute(array(':client_tel'=>$client_tel, ':client_tel2'=>$client_tel2, ':client_tel3'=>$client_tel3, ':client_login'=>$client_login, ':unit_desc'=>$unit_desc, ':client_adr'=>$client_adr, ':client_mail'=>$client_mail, ':client_mail2'=>$client_mail2, ':client_mail3'=>$client_mail3, ':client_cod'=>$client_cod, ':client_site'=>$client_site, ':client_region'=>$client_region, ':client_posada'=>$client_posada, ':client_id_param'=>$client_id_param));
...
//добавление тикета в бд
                $stmt = $dbConnection->prepare('INSERT INTO tickets
								(id, user_init_id,user_to_id,date_create,subj,msg, client_id, unit_id, status, hash_name, prio, last_update, err, tdate) VALUES (:max_id_res_ticket, :user_init_id, :user_to_id, now(),:subj, :msg,:max_id,:unit_id, :status, :hashname, :prio, now(), :err, :tdate)');
                $stmt->execute(array(':max_id_res_ticket'=>$max_id_res_ticket,':user_init_id'=>$user_init_id,':user_to_id'=>$user_to_id,':subj'=>$subj,':msg'=>$msg,':max_id'=>$client_id_param,':unit_id'=>$unit_id,':status'=>$status,':hashname'=>$hashname,':prio'=>$prio,':err'=>$err,':tdate'=>$tdate));
