...
<link rel="manifest" href="<?=$CONF['hostname']?>/img/favicon/manifest.json">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="<?=$CONF['hostname']?>/img/favicon/ms-icon-144x144.png">
...
<link rel="stylesheet" href="<?=$CONF['hostname']?>/css/daterangepicker.css">
