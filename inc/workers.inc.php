...
<div class="control-group">
    <div class="controls">
        <div class="form-group">
            ...
            <div class="col-sm-10" style="">
                <select name="region" data-placeholder="<?=lang('WORKER_region');?>" class="chosen-select form-control input-sm">
                    <option value="0"></option>
                    <?php
                    /*$qstring = "SELECT name FROM units order by name COLLATE utf8_unicode_ci ASC";
                    $result = mysql_query($qstring);//query the database for entries containing the term
                    ...
                    {*/
                            ...
                            $stmt = $dbConnection->prepare('SELECT name FROM region order by name COLLATE utf8_unicode_ci ASC');
		$stmt->execute();
		$res1 = $stmt->fetchAll();                 
        ...
        foreach($res1 as $row) {
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    <label for="tel2" class="col-sm-2 control-label"><small><?=lang('WORKER_tel2');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tel2" class="form-control input-sm" id="tel2" placeholder="<?=lang('WORKER_tel_full');?>" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tel3" class="col-sm-2 control-label"><small><?=lang('WORKER_tel3');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tel3" class="form-control input-sm" id="tel3" placeholder="<?=lang('WORKER_tel_full');?>" value="">
                                    </div>
                                </div>								
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="email2" class="col-sm-2 control-label"><small><?=lang('WORKER_mail2');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mail2" class="form-control input-sm" id="email2" placeholder="<?=lang('WORKER_mail2');?>" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email3" class="col-sm-2 control-label"><small><?=lang('WORKER_mail3');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mail3" class="form-control input-sm" id="email3" placeholder="<?=lang('WORKER_mail3');?>" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cod" class="col-sm-2 control-label"><small><?=lang('WORKER_cod');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cod" class="form-control input-sm" id="cod" placeholder="<?=lang('WORKER_cod');?>" value="">
                                    </div>
                                </div>	
                                <div class="form-group">
                                    <label for="site" class="col-sm-2 control-label"><small><?=lang('WORKER_site');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="site" class="form-control input-sm" id="site" placeholder="<?=lang('WORKER_site');?>" value="">
                                    </div>
                                </div>									
                                <div class="col-sm-6">
                                </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <table class="tbl table table-striped table-bordered">
        <thead class="jplist-panel">
          <tr>
			...
			<th><center><small><?=lang('WORKER_tel2');?>		</small></center></th>
			<th><center><small><?=lang('WORKER_tel3');?>		</small></center></th>
			...
			<th><center><small><?=lang('WORKER_mail2');?>		</small></center></th>
			<th><center><small><?=lang('WORKER_mail3');?>		</small></center></th>
			<th><center><small><?=lang('WORKER_cod');?>		</small></center></th>
			<th><center><small><?=lang('WORKER_site');?>		</small></center></th>	
			<th><center><small><?=lang('WORKER_region');?>		</small></center></th>			
    ...
    $t=($_POST['t']);
	    ...
	    //$results = mysql_query("SELECT id, fio, login, tel, unit_desc, adr, email, posada from clients where ((fio like '%" . $t . "%') or (login like '%" . $t . "%')) limit $start_pos, $perpage;");
	        ...
	        $stmt = $dbConnection->prepare('SELECT id, fio, login, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, region, posada  from clients where ((fio like :t) or (login like :t2)) limit :start_pos, :perpage');
	...
	//$results = mysql_query("SELECT id, fio, login, tel, unit_desc, adr, email, posada from clients limit $start_pos, $perpage;");
		    ...
		    $stmt = $dbConnection->prepare('SELECT id, fio, login, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, region, posada  from clients limit :start_pos, :perpage');
	...
	?>
          <tr class="tbl-item">
            ...
            <td><small><?=$row['tel2'];?></small></td>
            <td><small><?=$row['tel3'];?></small></td>			
            <td><small><?=$row['unit_desc'];?></small></td>
            <td><small><?=$row['adr'];?></small></td>
            <td><small><a href="mailto:<?=$row['email'];?>" target="_blank"><?=$row['email'];?></a></small></td>
            <td><small><a href="mailto:<?=$row['email'];?>" target="_blank"><?=$row['email2'];?></a></small></td>
            <td><small><a href="mailto:<?=$row['email'];?>" target="_blank"><?=$row['email3'];?></a></small></td>
            <td><small><?=$row['cod'];?></small></td>
            <td><small><a href="<?=$row['site'];?>" target="_blank"><?=$row['site'];?></small></a></td>
   ...
   /*$query = "SELECT id, fio, tel, login, unit_desc, adr, email, posada from clients where id='$usid'; ";
    $sql = mysql_query($query) or die(mysql_error());
	    ...
	    */
		    ...
		    $stmt = $dbConnection->prepare('SELECT id, fio, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, posada, region from clients where id=:usid');
    ...
    <div class="controls">
        ...
        foreach($res1 as $row) {
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    <label for="tel" class="col-sm-2 control-label"><small><?=lang('WORKER_tel2');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tel2" class="form-control input-sm" id="tel2" placeholder="<?=lang('WORKER_tel_full');?>" value="<?=$tel2;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tel" class="col-sm-2 control-label"><small><?=lang('WORKER_tel3');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tel3" class="form-control input-sm" id="tel3" placeholder="<?=lang('WORKER_tel_full');?>" value="<?=$tel3;?>">
                                    </div>
                                </div>								
                                <div class="form-group">
                                    <label for="adr" class="col-sm-2 control-label"><small><?=lang('WORKER_room');?></small></label>
                                ...
                                <div class="form-group">
                                    <label for="email2" class="col-sm-2 control-label"><small><?=lang('WORKER_mail2');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mail2" class="form-control input-sm" id="email2" placeholder="<?=lang('WORKER_mail2');?>" value="<?=$email2;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email3" class="col-sm-2 control-label"><small><?=lang('WORKER_mail3');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mail3" class="form-control input-sm" id="email3" placeholder="<?=lang('WORKER_mail3');?>" value="<?=$email3;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cod" class="col-sm-2 control-label"><small><?=lang('WORKER_cod');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cod" class="form-control input-sm" id="cod" placeholder="<?=lang('WORKER_cod');?>" value="<?=$cod;?>">
                                    </div>
                                </div>	
                                <div class="form-group">
                                    <label for="site" class="col-sm-2 control-label"><small><?=lang('WORKER_site');?></small></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="site" class="form-control input-sm" id="site" placeholder="<?=lang('WORKER_site');?>" value="<?=$site;?>">
                                    </div>
                                </div>									
