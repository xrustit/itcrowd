  ...
  <table class="tbl table table-striped table-bordered">
    ...
    $t=($_POST['t']);
	    ...
	    //$results = mysql_query("SELECT id, fio, login, tel, unit_desc, adr, email, posada from clients where ((fio like '%" . $t . "%') or (login like '%" . $t . "%')) limit $start_pos, $perpage;");
	        ...
	        $stmt = $dbConnection->prepare('SELECT id, fio, login, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, posada  from clients where ((fio like :t) or (login like :t2)) limit :start_pos, :perpage');
	...
	//$results = mysql_query("SELECT id, fio, login, tel, unit_desc, adr, email, posada from clients limit $start_pos, $perpage;");
		    ...
		    $stmt = $dbConnection->prepare('SELECT id, fio, login, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, posada  from clients limit :start_pos, :perpage');
	...
	?>
          <tr class="tbl-item">
            ...
            <td><small><?=$row['email2'];?></small></td>
            <td><small><?=$row['email3'];?></small></td>
            <td><small><?=$row['cod'];?></small></td>
            <td><small><?=$row['site'];?></small></td>			
   ...
   /*$query = "SELECT id, fio, tel, login, unit_desc, adr, email, posada from clients where id='$usid'; ";
    $sql = mysql_query($query) or die(mysql_error());
	    ...
	    */
		    ...
		    $stmt = $dbConnection->prepare('SELECT id, fio, tel, tel2, tel3, unit_desc, adr, email, email2, email3, cod, site, posada  from clients where id=:usid');
