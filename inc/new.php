            ...
            <div class="col-sm-10" style=" padding-top: 5px; ">
				...
				-->	
                    ...
                    <div class="btn-group" style="display:none">
                        <button type="button" class="btn btn-warning btn-xs" id="prio_error"><i id="lprio_error" class=""></i> <?=lang('NEW_prio_error');?></button>
                    </div>
					-->		
                </div>
            </div></div></div></div>
...
<div class="control-group">
    <div class="controls">
        <div class="form-group" id="for_msg">
            ...
            <div class="col-sm-10">
                <textarea data-toggle="popover" data-html="true" data-trigger="manual" data-placement="right" data-content="<small><?=lang('NEW_MSG_msg');?></small>" placeholder="<?=lang('NEW_MSG_ph');?>" class="form-control input-sm animated" name="msg" id="msg" rows="3" aria-invalid="false"></textarea>
            </div>
        </div>
...
<div class="control-group">
    <div class="controls">
        <div class="form-group" id="for_tdate">
            ...
            <div class="col-sm-10">
				<input type="date" class="form-control input-sm" name="tdate" id="tdate" placeholder="<?=lang('NEW_TDATE_msg');?>" data-toggle="popover" data-html="true" data-trigger="manual" data-placement="right" data-content="<small><?=lang('NEW_TDATE_msg');?></small>">
            </div>
        </div>
