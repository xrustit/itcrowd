...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?=$CONF['hostname']?>index.php"><img src="<?=$CONF['hostname']?>/img/favicon-32x32.png"> <?=$CONF['name_of_firm']?></a>
    </div>
 ...
 if ( ($priv_val == "2") || ($priv_val == "0") ) { ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li <?=echoActiveClassIfRequestMatches("report")?>><a href="<?=$CONF['hostname']?>report"><i class="fa fa-file-text"></i> <?=lang('NAVBAR_report');?></a></li>					
