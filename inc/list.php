                ...
                <div class="col-md-3" style="padding-top:20px;">
					...
					<div class="jplist-panel box panel-top">						
                        ...
                        <div class="text-filter-box">
                            <input data-path=".title" type="text" value="" placeholder="Поиск по контрагенту" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" />
                        </div>

      <!-- reset button -->
      <button type="button" class="jplist-reset-btn" data-control-type="reset" data-control-name="reset" data-control-action="reset" title="Сброс"><i class="fa fa-share"></i>
      </button>
...
/*             if (isset($_GET['find'])) {
            ...
            ?>
                    ...
                    <div class="jplist-panel box panel-bottom">
                        ...
                        <div 
                            ...
                            <ul>
                                <li><span data-number="20"> 20 стр. </span></li>
                                <li><span data-number="50"> 50 стр. </span></li>                                
                                <li><span data-number="all" data-default="true"> Показать все </span></li>
                            </ul>
                        </div>
        ...
        if (isset($_SESSION['hd.rustem_list_in'])) {
	      ...
	      switch($_SESSION['hd.rustem_list_in']) {
			...
			case '30': 	$ac['30']="active";		break;
			default: $ac['30']="active";
}	
        }
	...
	default: $button_sort_in['main']="active";
                ...
                ?>
                    ...
                    <div class="pull-right _pull-left">
...
<div class="btn-group btn-group-xs" >
  ...
  <button id="list_set_ticket" type="button" class="btn btn-default <?=$ac['30'];?>">30</button>
</div>
